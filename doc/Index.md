...
- [Overview](overview/index.md)
  ...
  - [Dynamic Capabilities - Visual Studio "15"](overview/dynamicCapabilities.md)
...
- Clients / Automation
  ...
  - [Obtaining the IProjectThreadingService/IThreadHandling service](automation/obtaining_the_IThreadHandling_service.md)
...
- [Extensibility points](extensibility/index.md)
  ...
  - [IProjectTreeModifier - Visual Studio 2015](extensibility/IProjectTreeModifier.md)
  - [IProjectTreePropertiesProvider - Visual Studio "15"](extensibility/IProjectTreePropertiesProvider.md)
...
- [Changes](../CHANGES.md)
- [Breaking Changes in Visual Studio "15"](overview/breaking_changes_visual_studio_next.md)
