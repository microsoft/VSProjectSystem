...
Project Tree Modifier/Properties Provider extension | Export that can tweak the appearance of your project in the Solution Explorer | Visual Studio Next: [IProjectPropertiesProvider](IProjectPropertiesProvider.md), Visual Studio 2015: [IProjectTreeModifier](IProjectTreeModifier.md)
